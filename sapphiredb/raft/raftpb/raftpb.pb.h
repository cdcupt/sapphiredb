...
#ifndef PROTOBUF_INCLUDED_raftpb_2eproto
#define PROTOBUF_INCLUDED_raftpb_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_raftpb_2eproto 
...
template<> ::raftpb::Storage* Arena::CreateMaybeMessage<::raftpb::Storage>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace raftpb {
...
class Storage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:raftpb.Storage) */ {
 public:
  ...
  private:
  const ::raftpb::Snapshot& _internal_snap() const;
  public:
  ...
  private:
  const ::raftpb::HardState& _internal_hardstate() const;
  public:
...
inline const ::raftpb::Snapshot& Storage::_internal_snap() const {
  return *snap_;
}
...
inline const ::raftpb::HardState& Storage::_internal_hardstate() const {
  return *hardstate_;
}
...
inline ::raftpb::HardState* Storage::mutable_hardstate() {
  ...
  if (hardstate_ == NULL) {
    auto* p = CreateMaybeMessage<::raftpb::HardState>(GetArenaNoVirtual());
    hardstate_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_raftpb_2eproto
